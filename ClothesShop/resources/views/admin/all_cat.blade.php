    ...
    <div class="panel panel-default">
      ...
      <div class="table-responsive">
        ...
        <table class="table table-striped b-t b-light">
          ...
          <tbody>
            @foreach ($all_category as $cat_prod)
            <tr>
              <td><label class="i-checks m-b-none"><input type="checkbox" name="post[]"><i></i></label></td>
              <td>{{$cat_prod->cat_name}}</td>
              ...
              <td><span class="text-ellipsis">{{$cat_prod->created_at}}</span></td>
              <td>
                <a href="{{ route('edit_cat', ['cat_product_id' => $cat_prod->cat_id]) }}" class="active" ui-toggle-class="">
