        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{ route('add_cat') }}">Thêm mới danh mục</a></li>
						<li><a href="{{ route('all_cat') }}">Liệt kê danh mục</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{ route('all_brand') }}">Liệt kê thương hiệu</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{ route('all_product') }}">Liệt kê sản phẩm</a></li>
                    </ul>
                </li>
            </ul>            
        </div>
